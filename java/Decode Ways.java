 ...
 class Solution {
    ...
    public int numDecodings(String s) {
        ...
        for (int i = 1; i <= length; ++i) {
            ...
            // If the current character is not '0', it can stand alone, so add current count
            // to next count
            if (s.charAt(i - 1) != '0') {
                nextCount = currentCount;
            }

            // If there are more than one characters and the substring of two characters can
            // represent a valid alphabet
