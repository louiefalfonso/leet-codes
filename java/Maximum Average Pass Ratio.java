...
class Solution {
    public double maxAverageRatio(int[][] classes, int extraStudents) {
        // Priority queue to store each class using a custom comparator based on the
        // improvement
        ...
        // Distribute the extra students to the classes where they would cause the
        // highest improvement
        ...
        // Calculate the total average ratio after all extra students have been
        // distributed
