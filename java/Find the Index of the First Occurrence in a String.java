    ...
    public int strStr(String haystack, String needle) {
        ...
        while (haystackPointer < haystackLength) {
            ...
            if (haystack.charAt(haystackPointer) == needle.charAt(needlePointer)) {
                // Special case: if needle length is 1 and characters match, we found the
                // needle.
                if (needleLength == 1) {
                ...
                // needlePointer had advanced, then move forward by one to search from next
                // position.
            ...
            if (needlePointer == needleLength) {
                ...
                // is at the difference between current haystackPointer and the length of the
                // needle.
                return haystackPointer - needlePointer;
            }
        }

        // Needle was not found in the haystack. Return -1 as specified in the problem
        // statement.
        return -1;
    }
}