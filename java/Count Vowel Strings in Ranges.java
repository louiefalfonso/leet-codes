 ...
 */
 ...
 class Solution {
    // Function to determine the number of words with a starting and ending vowel in
    // given queries.
    public int[] vowelStrings(String[] words, int[][] queries) {
        ...
        // An array to store the cumulative count of words that start and end with a
        // vowel.
        ...
        for (int i = 0; i < wordCount; ++i) {
            ...
            // Update the cumulative count. Increment if both first and last chars are
            // vowels.
            cumulativeVowelCount[i + 1] = cumulativeVowelCount[i]
                    + (vowels.contains(firstChar) && vowels.contains(lastChar) ? 1 : 0);
        }
        ...
        // Process each query to get the number of words that start and end with a
        // vowel.
