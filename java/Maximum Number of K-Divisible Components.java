 ...
 */
 ...
 class Solution {
    ...
    private int[] nodeValues; // Renamed 'values' to 'nodeValues' to avoid confusion with the method parameter
                              // 'values'
    ...
    public int maxKDivisibleComponents(int n, int[][] edges, int[] values, int k) {
        ...
        // Add edges to the graph to represent the bidirectional relationships between
        // nodes
        for (int[] edge : edges) {
