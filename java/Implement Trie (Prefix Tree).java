 ...
 */
 ...
 class Trie {
    ...
    // Helper method to search for a prefix or a whole word in the trie and return
    ...
    private Trie searchPrefix(String s) {
        ...
        for (char letter : s.toCharArray()) {
            int index = letter - 'a';
            if (currentNode.children[index] == null) {
                // If the next node doesn't exist, return null indicating the prefix doesn't
                // exist.
                return null;
            }
            // Move to the next Trie node.
        ...
        return currentNode; // The node where the search ended, could represent the prefix or the whole
                            // word.
    }
}