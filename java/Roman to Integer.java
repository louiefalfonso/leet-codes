...
class Solution {
    public int romanToInt(String s) {
        ...
        int length = s.length();
        // Start with the value of the last symbol as there is nothing following it to
        // compare.
        ...
        for (int i = 0; i < length - 1; ++i) {
            // Determine the sign based on whether the current symbol is less than the one
            // following it.
        ...
        // Return the computed total value as the integer value of the input Roman
        // numeral.
        return totalValue;
    }
}